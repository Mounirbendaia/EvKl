...
export default function venue4() {
  ...
  const STORAGE_KEY25 = '@save_np25';
  const STORAGE_KEY23 = '@save_name23';
  const STORAGE_KEY33 = '@save_name33';
  const STORAGE_KEY43 = '@save_name43';
  const STORAGE_KEY53 = '@save_name53';
  const STORAGE_KEY63 = '@save_name63';
  const STORAGE_KEY73 = '@save_name73';
  const STORAGE_KEY83 = '@save_name83';
  const STORAGE_KEY93 = '@save_name93';
  const STORAGE_KEY103 = '@save_name103';
  const STORAGE_KEY113 = '@save_name113';
  const STORAGE_KEY123 = '@save_name123';
  const STORAGE_KEY133 = '@save_name133';
  const STORAGE_KEY143 = '@save_name143';
  const STORAGE_KEY153 = '@save_name153';
  const saveData = async () => {
    try {
      await AsyncStorage.setItem(STORAGE_KEY25, name1)
      await AsyncStorage.setItem(STORAGE_KEY23, name2)
      await AsyncStorage.setItem(STORAGE_KEY33, name3)
      await AsyncStorage.setItem(STORAGE_KEY43, name4)
      await AsyncStorage.setItem(STORAGE_KEY53, name5)
      await AsyncStorage.setItem(STORAGE_KEY63, name6)
      await AsyncStorage.setItem(STORAGE_KEY73, name7)
      await AsyncStorage.setItem(STORAGE_KEY83, name8)
      await AsyncStorage.setItem(STORAGE_KEY93, name9)
      await AsyncStorage.setItem(STORAGE_KEY103, name10)
      await AsyncStorage.setItem(STORAGE_KEY113, name11)
      await AsyncStorage.setItem(STORAGE_KEY123, name12)
      await AsyncStorage.setItem(STORAGE_KEY133, name13)
      await AsyncStorage.setItem(STORAGE_KEY143, name14)
      await AsyncStorage.setItem(STORAGE_KEY153, name15)
  ...
  const readData = async () => {
    try {
      const userName = await AsyncStorage.getItem(STORAGE_KEY25)
      const userName2 = await AsyncStorage.getItem(STORAGE_KEY23)
      const userName3 = await AsyncStorage.getItem(STORAGE_KEY33)
      const userName4 = await AsyncStorage.getItem(STORAGE_KEY43)
      const userName5 = await AsyncStorage.getItem(STORAGE_KEY53)
      const userName6 = await AsyncStorage.getItem(STORAGE_KEY63)
      const userName7 = await AsyncStorage.getItem(STORAGE_KEY73)
      const userName8 = await AsyncStorage.getItem(STORAGE_KEY83)
      const userName9 = await AsyncStorage.getItem(STORAGE_KEY93)
      const userName10 = await AsyncStorage.getItem(STORAGE_KEY103)
      const userName11 = await AsyncStorage.getItem(STORAGE_KEY113)
      const userName12 = await AsyncStorage.getItem(STORAGE_KEY123)
      const userName13 = await AsyncStorage.getItem(STORAGE_KEY133)
      const userName14 = await AsyncStorage.getItem(STORAGE_KEY143)
      const userName15 = await AsyncStorage.getItem(STORAGE_KEY153)
      if (userName !== null) {
        setName1(userName)
      }
      if (userName2 !== null) {
...
const onSubmitEditing = () => {
 ...
 <Text style={styles.welcome}>Welcome to Venue 4</Text>
